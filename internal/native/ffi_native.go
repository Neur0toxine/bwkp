...
#cgo windows LDFLAGS: ${SRCDIR}/../../target/release/libbwkp_native.a -L${SRCDIR}/../../target/keepassxc/lib -lbwkp_kpdb -lkeepassx_core -lautotype -lqrcode -lzxcvbn -lqrencode -lbotan-3 -largon2 -lminizip -lz -lwtsapi32 -lbcrypt -lws2_32 -luserenv -lntdll
