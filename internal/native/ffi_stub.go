...
func mutate(Handle, []byte) ([]byte, error)             { return nil, ErrUnavailable }
func uploadAttachment(Handle, []byte, []byte) ([]byte, error) {
...
func readKDBX(string, []byte) ([]byte, error)        { return nil, ErrUnavailable }
